...
<body class="">
  ...
  <form class="modal fade" id="formAlta" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="col-lg-12">
          <!-- <div class="form-group classid">
            <input name="id" type="number" class="form-control form-control-user ocultarID" id="altaID" placeholder="id" />
          </div> -->
  ...
  <script>
    ...
    $(document).ready(function() {
      opcion = 0;
      fetch(`http://localhost/newproyect_lepa/api/categorias.php?opcion=${opcion}`, {
          method: "GET",
          headers: {
    ...
    function consultarUnCliente(id) {
      ...
      console.log(id);
      fetch(
          `http://localhost/newproyect_lepa/api/categorias.php?id=${id}&opcion=${opcion}`, {
            method: 'GET',
            headers: {
              Accept: "application/json",
              "Content-Type": "application/json",
    ...
    document.getElementById('modalConsulta').addEventListener('submit', function(e) {
      ...
      fetch(
          'http://localhost/newproyect_lepa/api/categorias.php', {
            method: 'POST',
            body: datos,
            headers: {
              Accept: "application/json",
    ...
    function eliminarCliente(id) {
      ...
      fetch(
        ...
        .then((respuesta) => respuesta.json())
        .then((datos) => {
          nombreCate = (datos[0].categoria);
          // pide confirmación para eliminar
          Swal.fire({
            title: 'Esta seguro?',
            text: "Aceptar para borrar a: " + nombreCate,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
              opcion = 3;
              fetch(`http://localhost/newproyect_lepa/api/categorias.php?id=${id}&opcion=${opcion}`, {
                  method: "GET",
                  headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
    ...
    function eliminarTodos() {
      ...
      Swal.fire({
        title: 'Esta seguro?',
        text: "Esta por eliminar TODAS las CATEGORIAS del sistema!!!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
    ...
    async function eliminar() {
      ...
      const {
        ...
        input: 'password',
        inputLabel: 'Ingrese su Password para eliminar TODAS las CATEGORIAS',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: 'Aceptar',
      ...
      if (password) {
        ...
        opcion = 5;
        fetch(
            `http://localhost/newproyect_lepa/api/categorias.php?password=${password}&opcion=${opcion}`, {
              method: 'GET',
              headers: {
                Accept: "application/json",
                "Content-Type": "application/json",
