...
<body class="">
  ...
  <script>
    ...
    $(document).ready(function() {
      opcion = 0;
      fetch(`http://localhost/newproyect_lepa/api/disciplinas.php?opcion=${opcion}`, {
          method: "GET",
          headers: {
    ...
    function consultarUnCliente(id) {
      ...
      fetch(
          `http://localhost/newproyect_lepa/api/disciplinas.php?id=${id}&opcion=${opcion}`, {
            method: 'GET',
            headers: {
              Accept: "application/json",
              "Content-Type": "application/json",
    ...
    document.getElementById('modalConsulta').addEventListener('submit', function(e) {
      ...
      fetch(
          'http://localhost/newproyect_lepa/api/disciplinas.php', {
            method: 'POST',
            body: datos,
            headers: {
              Accept: "application/json",
        ...
        .then((datos) => {
          ...
          if (datos == 1) {
            Swal.fire({
              icon: 'success',
              title: 'Ok!',
              text: 'Disciplina ingresada con exito!',
            }).then((result) => {
              window.location.reload();
            });
          } else {
    ...
    function eliminarCliente(id) {
      ...
      fetch(
        ...
        .then((respuesta) => respuesta.json())
        .then((datos) => {
          nombreDisc = (datos[0].disciplina);
          // pide confirmación para eliminar
          Swal.fire({
            title: 'Esta seguro?',
            text: "Aceptar para borrar a: " + nombreDisc,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
              opcion = 3;
              fetch(`http://localhost/newproyect_lepa/api/disciplinas.php?id=${id}&opcion=${opcion}`, {
                  method: "GET",
                  headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
    ...
    async function eliminar() {
      ...
      if (password) {
        ...
        opcion = 5;
        fetch(
            `http://localhost/newproyect_lepa/api/disciplinas.php?password=${password}&opcion=${opcion}`, {
              method: 'GET',
              headers: {
                Accept: "application/json",
                "Content-Type": "application/json",
