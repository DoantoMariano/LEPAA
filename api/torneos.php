...
switch ($opcion) {
    ...
    case 2:
        ...
        if (isset($id)) {
            ...
            $sql = "UPDATE torneo SET nombretorneo = '$torneo', dnimod = '$dnimod', nombremod = '$nombremod', apellidomod = '$apellidomod', cuitmod = '$cuitmod', institucionmod = '$institucionmod', fechamod = '$fechamod' WHERE torneo.id = $id;";
    ...
    case 4:
        ...
        if ($numeroRegistros == 0) {
            ...
            $sql = "INSERT INTO torneo (nombretorneo, fechatorneo, dnialta, nombrealta, apellidoalta, cuitalta, institucionalta, fechaalta) VALUES ('$torneo', '', '$dnialta', '$nombrealta', '$apellidoalta', '$cuitalta', '$institucionalta', '$fechaalta')";
