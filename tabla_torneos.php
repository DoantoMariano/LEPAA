...
<body class="">
      ...
      <div class="modal-content">
        ...
        <div class="col-lg-12">
          ...
          <div class="orm-group form-floating">
            <input name="torneo" type="text" class="form-control form-control-user" id="consultarTorneo" placeholder="Torneo" required />
  ...
  <script>
    ...
    $(document).ready(function() {
      opcion = 0;
      fetch(`http://localhost/newproyect_lepa/api/torneos.php?opcion=${opcion}`, {
          method: "GET",
          headers: {
    ...
    function consultarUnCliente(id) {
      ...
      fetch(
          `http://localhost/newproyect_lepa/api/torneos.php?id=${id}&opcion=${opcion}`, {
            method: 'GET',
            headers: {
              Accept: "application/json",
              "Content-Type": "application/json",
    ...
    document.getElementById('modalConsulta').addEventListener('submit', function(e) {
      ...
      fetch(
          'http://localhost/newproyect_lepa/api/torneos.php', {
            method: 'POST',
            body: datos,
            headers: {
              Accept: "application/json",
        ...
        .then((datos) => {
          ...
          if (datos == 1) {
            Swal.fire({
              icon: 'success',
              title: 'Ok!',
              text: 'Torneo ingresad con exito!',
            }).then((result) => {
              window.location.reload();
            });
          } else {
    ...
    function eliminarCliente(id) {
      ...
      fetch(
        ...
        .then((respuesta) => respuesta.json())
        .then((datos) => {
          nombreTor = (datos[0].nombretorneo);
          // pide confirmación para eliminar
          Swal.fire({
            title: 'Esta seguro?',
            text: "Aceptar para borrar: " + nombreTor,
            icon: 'warning',
            ...
            if (result.isConfirmed) {
              opcion = 3;
              fetch(`http://localhost/newproyect_lepa/api/torneos.php?id=${id}&opcion=${opcion}`, {
                  method: "GET",
                  headers: {
                    Accept: "application/json",
                    "Content-Type": "application/json",
                ...
                .then((datos) => {
                  ...
                  if (datos == 1) {
                    Swal.fire({
                      icon: 'success',
                      title: 'Ok!',
                      text: 'Torneo eliminado con exito!',
                    }).then((result) => {
                      window.location.reload();
                    });
                  } else {
                    Swal.fire({
                      icon: 'error',
                      title: 'Ups..!',
                      text: 'El Torneo no pudo eliminarse!',
                    })
                  };
                });
            }
    ...
    function eliminarTodos() {
      ...
      Swal.fire({
        title: 'Esta seguro?',
        text: "Esta por eliminar TODOS los TORENOS del sistema!!!",
        icon: 'warning',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
    ...
    async function eliminar() {
      ...
      const {
        ...
        input: 'password',
        inputLabel: 'Ingrese su Password para eliminar TODOS los TORNEOS',
        showCancelButton: true,
        confirmButtonColor: '#3085d6',
        cancelButtonColor: '#d33',
        confirmButtonText: 'Aceptar',
      ...
      if (password) {
        opcion = 5;
        fetch(
            `http://localhost/newproyect_lepa/api/torneos.php?password=${password}&opcion=${opcion}`, {
              method: 'GET',
              headers: {
                Accept: "application/json",
                "Content-Type": "application/json",
        ...
        Swal.fire({
          icon: 'info',
          title: 'Info..!',
          text: 'Debe introducir su password para eliminr todos los Torneos.',
        });
      };
    }
    // === FIN ELIMINAR TODOS LOS DATOS ===
